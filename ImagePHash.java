...
public class ImagePHash {
	...
	// private HashMap<String, BufferedImage> image2 = new HashMap<>();
	...
	private void loadImages() {
		// Load images
		try {
			// image1 = ImageIO.read(new File("images/mat3.jpg"));
			// image2= ImageIO.read(new File("images/mat2.jpg"));
			images.put("mat1", ImageIO.read(getClass().getResourceAsStream("images/mat1.jpg")));
			images.put("mat2", ImageIO.read(getClass().getResourceAsStream("images/mat2.jpg")));
			images.put("mat3", ImageIO.read(getClass().getResourceAsStream("images/mat3.jpg")));
			images.put("mat4", ImageIO.read(getClass().getResourceAsStream("images/mat4.jpg")));
			images.put("mat5", ImageIO.read(getClass().getResourceAsStream("images/mat5.jpg")));
		} catch (IOException e) {
			e.printStackTrace();
		}
